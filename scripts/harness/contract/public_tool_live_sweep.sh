...
echo "[1/39] initialize MCP session"
initialize_mcp_session || {
  echo "FAIL: failed to initialize MCP session" >&2
  exit 1
}

echo "[2/39] tools/list matches expected public surface"
...
echo "[14/35] masc_batch_add_tasks"
