...
class GoalLoopCompletionAuditTest(unittest.TestCase):
    ...
    def test_completion_audit_attaches_prompt_closeout_checklist(self) -> None:
        ...
        self.assertEqual(checklist_evidence["status_counts"]["PASS"], 8)
        self.assertEqual(checklist_evidence["status_counts"]["PARTIAL"], 11)
        self.assertEqual(checklist_evidence["status_counts"]["BLOCKED"], 2)
        self.assertEqual(checklist_evidence["non_pass_requirements"], 13)
        self.assertEqual(
        ...
        self.assertEqual(checklist_evidence["artifact_refs_total"], 83)
        self.assertEqual(checklist_evidence["artifact_refs_resolved"], 83)
        self.assertEqual(checklist_evidence["artifact_ref_anchors_total"], 19)
        ...
        self.assertEqual(closeout_evidence["non_pass_requirements"], 13)
        self.assertEqual(
    ...
    def test_completion_audit_rejects_missing_prompt_artifact_refs(self) -> None:
        ...
        self.assertEqual(checklist_evidence["artifact_refs_total"], 82)
        self.assertEqual(checklist_evidence["artifact_refs_resolved"], 81)
        self.assertEqual(
    ...
    def test_completion_audit_rejects_missing_prompt_artifact_ref_anchors(self) -> None:
        ...
        self.assertFalse(checklist_evidence["recorded"])
        self.assertFalse(checklist_evidence["artifact_refs_all_resolved"])
        self.assertEqual(checklist_evidence["artifact_refs_total"], 81)
        self.assertEqual(checklist_evidence["artifact_refs_resolved"], 80)
        self.assertEqual(checklist_evidence["artifact_ref_anchors_total"], 19)
        self.assertEqual(checklist_evidence["artifact_ref_anchors_resolved"], 18)
        self.assertEqual(
