...
OAS Pin Snapshot: dependency floor `0.121.0`, runtime pin `main@a296b2d625b199561183aace90b25516251691f6`, declared base version `v0.121.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@a296b2d625b199561183aace90b25516251691f6`, declared base version `v0.121.0`, dependency floor `0.121.0`.
