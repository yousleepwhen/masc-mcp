...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.170.2`, runtime pin: `fix/pipeline-message-constructor@e7c3e45c5fe5c9ac90a5d53e8e5b0279988742b7`, declared base version: `v0.170.2`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
