  ...
  return html`
    <${Card} title="활동 타임라인" testId="activity_swimlane">
      ...
      <div class="flex flex-wrap gap-3 mt-3 text-2xs text-[var(--color-fg-muted)]">
        <span class="flex items-center gap-1.5"><span class="w-3 h-2 rounded-sm bg-[var(--color-status-warn)] inline-block" aria-hidden="true"></span>작업</span>
        <span class="flex items-center gap-1.5"><span class="w-3 h-2 rounded-sm bg-[var(--color-status-ok)] inline-block" aria-hidden="true"></span>운영</span>
