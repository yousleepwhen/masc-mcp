          ...
          ? html`
              <div class="flex flex-wrap gap-2" data-testid="runtime-truth-strip">
                ...
                <span
                  ...
                  title="운영자 disposition, 터미널 에러, 또는 tool contract 위반 증거가 있는 row"
                >
      ...
      ${isFiltering && visibleSnapshots.length === 0
        ? html`
            <div
              ...
              class="p-4 text-center text-xs text-[var(--color-fg-muted)]"
              role="status"
              aria-live="polite"
            >
                              ...
                              ${runtimeActions.map(action => {
                                ...
                                return html`
                                  <button
                                    ...
                                    class="self-start rounded border border-[var(--white-10)] bg-[var(--white-5)] px-2 py-0.5 text-3xs font-semibold ${runtimeActionTone(action)} hover:bg-[var(--white-10)] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent-fg)] focus-visible:ring-offset-1 focus-visible:ring-offset-[var(--color-bg-page)]"
                                    title=${action.reason}
